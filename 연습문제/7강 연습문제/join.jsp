...
<form name="frm" id="reg_frm" action="JoinServlet">
   ...
   <input type="text" id="name" name="name" value="김유진"> <br>
  
   <label>주민등록번호  </label><span style="color:red;"> * </span>
   <input type="text" name="jumin_1" value="123456"> - 
   <input type="text" name="jumin_2" value="1234567"> <br>
   
   <label for="id"> 아이디  </label><span style="color:red;"> * </span>
   <input type="text" id="id" name="id" value="yj182637"><br>
    ...
    <input type="text" name="email" value="yj182637"> @ 
    ...
    <input type="text" id="addr1" name="addr1"  value="수원시 권선구">
    <input type="text" name="addr2" value="그린컴퓨터"><br>
